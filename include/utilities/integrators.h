...
static inline void performNBodyHalfStepA(uint64_t n, float dt, float* p,
                                         float* v, const float* a,
                                         const float* m) {
...
static inline void performNBodyHalfStepB(uint64_t n, float dt, const float* p,
                                         float* v, const float* a,
                                         const float* m) {
  for (uint64_t i = 0; i < n; ++i) {
    // kick
...
static inline void performNBodyStep(const int localN, const int n, float* m,
                                    float* p, float* p_, float* v, float* v_,
                                    const float dt) {
