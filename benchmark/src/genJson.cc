...
int main(int argc, char** argv) {
    std::string name[] = {"All Pairs Sequential", "All Pairs Sequential with AVX instructions",  "All Pairs with OpenMP - static schedule", "All Pairs with OpenMP - dynamic schedule", "Barnes-Hut Sequential", "Barnes-Hut Sequential - dynamic schedule", "Barnes-Hut Sequential - static schedule"};
