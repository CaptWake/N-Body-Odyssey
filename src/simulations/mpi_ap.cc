...
void MPIAPSimulate(uint64_t n, float dt, float tEnd, uint64_t seed) {
  ...
  MPI_Scatter(pp, localN*3, MPI_FLOAT, p, localN*3, MPI_FLOAT, 0, MPI_COMM_WORLD);
  MPI_Scatter(vv, localN*3, MPI_FLOAT, v, localN*3, MPI_FLOAT, 0, MPI_COMM_WORLD);
  MPI_Scatter(aa, localN*3, MPI_FLOAT, a, localN*3, MPI_FLOAT, 0, MPI_COMM_WORLD);
  ...
  MPI_Gather(p, localN*3, MPI_FLOAT,
             pp, localN*3, MPI_FLOAT,
             0, MPI_COMM_WORLD);
  MPI_Gather(v, localN*3, MPI_FLOAT,
             vv, localN*3, MPI_FLOAT,
             0, MPI_COMM_WORLD);
...
void SequentialAPSimulate(int n, float dt, float tEnd, uint64_t seed){
  ...
  for (float t = 0.0f; t < tEnd; t += dt){
    ...
    MPI_Allgather(p_, 3*localN, MPI_FLOAT, p, 3*localN, MPI_FLOAT, MPI_COMM_WORLD);
    MPI_Allgather(v_, 3*localN, MPI_FLOAT, v, 3*localN, MPI_FLOAT, MPI_COMM_WORLD);
  }
